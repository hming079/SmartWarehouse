    ...
    <tr className="border-b border-purple-100 last:border-b-0">
      ...
      <td className="px-4 py-4">
        <div className="flex items-center gap-2">
          <button className="rounded-lg border border-blue-500 px-3 py-1 text-sm font-medium text-blue-600 hover:bg-blue-50">
            Edit
          </button>
          <button className="rounded-lg bg-red-500 px-3 py-1 text-sm font-medium text-white hover:bg-red-600">
            Delete
          </button>
        </div>
      </td>
